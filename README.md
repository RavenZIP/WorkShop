...
<img alt="Static Badge" src="https://img.shields.io/badge/v1.7.1-red">
</p>
...
```
dependencies {
      implementation("com.github.RavenZIP:WorkShop:1.7.1")
}
```
...
```
https://jitpack.io/com/github/RavenZIP/WorkShop/1.7.1/WorkShop-1.7.1-sources.jar
```
