...
<img alt="Static Badge" src="https://img.shields.io/badge/v2.6.1-red">
</p>
...
⚠️ **ВНИМАНИЕ: Проект более не поддерживается.**
Разработка остановлена, и новые фичи или доработки уже существующих фич не планируются. Рекомендуется использовать [Composia](https://github.com/RavenZIP/Composia)
...
```
dependencies {
      implementation("com.github.RavenZIP:WorkShop:2.6.1")
}
```
...
```
https://jitpack.io/com/github/RavenZIP/WorkShop/2.6.1/WorkShop-2.6.1-sources.jar
```
