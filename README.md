...
<img alt="Static Badge" src="https://img.shields.io/badge/v2.0.4-red">
</p>
...
```
dependencies {
      implementation("com.github.RavenZIP:WorkShop:2.0.4")
}
```
...
```
https://jitpack.io/com/github/RavenZIP/WorkShop/2.0.4/WorkShop-2.0.4-sources.jar
```
