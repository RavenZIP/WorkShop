...
<img alt="Static Badge" src="https://img.shields.io/badge/v1.6.3-red">
</p>
...
```
dependencies {
      implementation("com.github.RavenZIP:WorkShop:1.6.3")
}
```
...
```
https://jitpack.io/com/github/RavenZIP/WorkShop/1.6.3/WorkShop-1.6.3-sources.jar
```
