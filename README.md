...
<img alt="Static Badge" src="https://img.shields.io/badge/v1.7.0-red">
</p>
...
```
dependencies {
      implementation("com.github.RavenZIP:WorkShop:1.7.0")
}
```
...
```
https://jitpack.io/com/github/RavenZIP/WorkShop/1.7.0/WorkShop-1.7.0-sources.jar
```
