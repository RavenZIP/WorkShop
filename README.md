...
<img alt="Static Badge" src="https://img.shields.io/badge/v2.2.1-red">
</p>
...
```
dependencies {
      implementation("com.github.RavenZIP:WorkShop:2.2.1")
}
```
...
```
https://jitpack.io/com/github/RavenZIP/WorkShop/2.2.1/WorkShop-2.2.1-sources.jar
```
