...
<img alt="Static Badge" src="https://img.shields.io/badge/v1.6.1-red">
</p>
...
```
dependencies {
      implementation("com.github.RavenZIP:WorkShop:1.6.1")
}
```
...
```
https://jitpack.io/com/github/RavenZIP/WorkShop/1.6.1/WorkShop-1.6.1-sources.jar
```
