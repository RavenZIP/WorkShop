...
<img alt="Static Badge" src="https://img.shields.io/badge/v1.5.1-red">
</p>
...
# 💡 Устранение проблемы с отображением исходников в коде
1. Скачать sources.jar той же версии, что и версия библиотеки в вашем проекте
```
https://jitpack.io/com/github/RavenZIP/WorkShop/1.5.1/WorkShop-1.5.1-sources.jar
```
...
Ранее этой проблемы не наблюдалось (примерно до версии 1.2.5) и решение пока что такое
