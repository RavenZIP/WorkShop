...
<img alt="Static Badge" src="https://img.shields.io/badge/Material%203-1.3.0-%232310699C">
<img alt="Static Badge" src="https://img.shields.io/badge/v2.1.0-red">
</p>
...
```
dependencies {
      implementation("com.github.RavenZIP:WorkShop:2.1.0")
}
```
...
```
https://jitpack.io/com/github/RavenZIP/WorkShop/2.1.0/WorkShop-2.1.0-sources.jar
```
