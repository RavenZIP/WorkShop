...
<img alt="Static Badge" src="https://img.shields.io/badge/v2.2.0-red">
</p>
...
```
dependencies {
      implementation("com.github.RavenZIP:WorkShop:2.2.0")
}
```
...
```
https://jitpack.io/com/github/RavenZIP/WorkShop/2.2.0/WorkShop-2.2.0-sources.jar
```
